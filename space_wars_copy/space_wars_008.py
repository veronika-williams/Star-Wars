"""
Игра Космические войны. Версия 0.8.
Анимация метеоров.
"""
...
pygame.display.set_caption("Космические войны. Версия 0.8")
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        #контролируем, чтобы не вышел за границы
...
class Meteor(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # при выходе за пределы игрового поля - перемещаем его в начало
